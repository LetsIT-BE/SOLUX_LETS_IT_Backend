...
public class ImgController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<String> handleFileUpload(@RequestParam("file") MultipartFile file, @RequestParam("userEmail") String userEmail) {
    ...
    @GetMapping("/image")
    public ResponseEntity<byte[]> getUserImg(@RequestParam String userEmail) {
